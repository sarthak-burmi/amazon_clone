...
import 'package:amazon_clone/view/seller/seller_nav_bar/seller_nav_bar.dart';
import 'package:amazon_clone/view/user/user_persistant_nav_bar/user_nav_bar.dart';
...
class _SignInLogicState extends State<SignInLogic> {
  ...
  checkAuthentication() {
    bool userAuthenticated = AuthServices.checkAuthentication();
    userAuthenticated
        ? checkUser()

...
class MonitorScreen extends StatefulWidget {
  ...
  @override
  State<MonitorScreen> createState() => _InventoryScreenState();
}

class _InventoryScreenState extends State<MonitorScreen> {
  @override
  void initState() {
    super.initState();
                        ...
                        return StreamBuilder(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (snapshot.hasError) {
                                return Text(
                                  "OOPS! Error in Loading Data Please Contact Admin ",
                                  style: textTheme.bodyMedium,
                                );
                              } else {
                                return SizedBox();

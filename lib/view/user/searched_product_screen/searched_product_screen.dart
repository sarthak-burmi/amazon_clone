...
import '../../../controller/provier/user_product_provider/user_product_provider.dart';
import '../../../controller/services/rating_services/rating_services.dart';
import '../../../controller/services/user_product_services/user_product_services.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Consumer<UsersProductProvider>(
          ...
          if (usersProductProvider.productFetched == false) {
            // return Center(
            ...
            if (usersProductProvider.searchedProduct.isEmpty) {
              return const Center(
                child: Text('Opps! Product not found'),
              );
            } else {
              return ListView.builder(
                  itemCount: usersProductProvider.searchedProduct.length,
                  shrinkWrap: true,
                  itemBuilder: (context, index) {
                    ProductModel currentProduct =
                        usersProductProvider.searchedProduct[index];
                    return InkWell(
                      onTap: () async {
